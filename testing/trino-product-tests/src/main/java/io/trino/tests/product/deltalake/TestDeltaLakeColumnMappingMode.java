        ...
        extends BaseTestDeltaLakeS3Storage
{
    ...
    @Flaky(issue = DATABRICKS_COMMUNICATION_FAILURE_ISSUE, match = DATABRICKS_COMMUNICATION_FAILURE_MATCH)
    public void testTrinoRenameColumnWithColumnMappingModeId()
    {
        testTrinoRenameColumnWithColumnMappingMode("id");
    }
    ...
    {
        testTrinoRenameColumnWithColumnMappingMode("name");
    }

    private void testTrinoRenameColumnWithColumnMappingMode(String mode)
    {
    ...
    {
        testSparkRenameColumnWithColumnMappingMode("id");
    }

    @Test(groups = {DELTA_LAKE_DATABRICKS, DELTA_LAKE_OSS, DELTA_LAKE_EXCLUDE_73, DELTA_LAKE_EXCLUDE_91, DELTA_LAKE_EXCLUDE_104, PROFILE_SPECIFIC_TESTS})
    @Flaky(issue = DATABRICKS_COMMUNICATION_FAILURE_ISSUE, match = DATABRICKS_COMMUNICATION_FAILURE_MATCH)
    public void testSparkRenameColumnWithColumnMappingModeName()
    {
        testSparkRenameColumnWithColumnMappingMode("name");
    }

    private void testSparkRenameColumnWithColumnMappingMode(String mode)
    {
